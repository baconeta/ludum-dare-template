...
namespace Utils
{
    /// https://github.com/StephenCleary/Dequeue
    /// <summary>
    ...
    public sealed class Dequeue<T> : IList<T>, IReadOnlyList<T>, System.Collections.IList
    {
        /// <summary>
        ...
        /// <summary>
        /// Copies the dequeue elements into an array. The resulting array always has all the dequeue elements contiguously.
        /// </summary>
        ...
        /// <summary>
        /// Creates and returns a new array containing the elements in this dequeue.
        /// </summary>
        public T[] ToArray()
        {
        ...
        private sealed class DebugView
        {
            ...
            public T[] Items => _dequeue.ToArray();
        }
    }
}